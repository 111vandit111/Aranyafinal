  ...
  return (
    <nav className={`app__navbar ${scrl}`}>
      <div className="app__navbar-logo">
        <Link to={"#Destination"}>
          <img src={"imgs/logo.png"} alt="app__logo" />
        </Link>
      </div>
        ...
        {toggleMenu && (
          <div className="app__navbar-smallscreen_overlay flex__center slide-bottom">
            ...
            <ul className="app__navbar-smallscreen_links">
              <li>
                <a href="#Destination" onClick={() => setToggleMenu(false)}>
                  Destination
                </a>
              </li>
              <li>
              ...
              <li>
                <Link to="stay" onClick={() => setToggleMenu(false)}>
                  Stay
                </Link>
              </li>
              <li>
                <Link to="experiences" onClick={() => setToggleMenu(false)}>
                  Experiences
                </Link>
              </li>
              <li>
                <Link to="dining" onClick={() => setToggleMenu(false)}>
                  Dining
                </Link>
              </li>
              <li>
